...
@Service            // @Service säger åt spring att detta är en service-klass
public class ProductService {

    // Instantierar ProductRepository
    ...
    public Product getProductById(Integer id) {
        ...
        Optional<Product> product = productRepository.findById(id);         // Optional<> hanterar null-värden för att förhindra att produkter får olika datatyper
        if (product.isEmpty()) {
